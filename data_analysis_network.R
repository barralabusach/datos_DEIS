#------------------------------------------------------------------------------#
# Code to perform distance matrix and network with the cardiovascular data set
#------------------------------------------------------------------------------#
### Clear memory space:
rm(list=ls())
...
colnames(distance_matrix) <- met_sur_names
rownames(distance_matrix) <- met_sur_names

###--------------------------------------------------------------------------###
# Create a network with the euclidean distances
###--------------------------------------------------------------------------###
