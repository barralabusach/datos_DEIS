...
# Filter data from between 2010 and 2018:
# 1.- Accidente vascular encefálico (id:14).
# 2.- Region metropolitana (id:13).
# 3.- From an hospital of the region.
# Load data:
setwd("data/")
...
# Filter data of 'accidente vascular encefalico' and one hospital:
sotacv <- list()
for (i in 1:16) {
